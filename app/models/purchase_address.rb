class PurchaseAddress
  ...
  attr_accessor :postal_code, :prefectures_id, :municipality, :address, :building_name, :phone_num, :user_id, :item_id,
                :token
  ...
  validates :prefectures_id, numericality: { other_than: 1, message: 'must be other than 1' }
